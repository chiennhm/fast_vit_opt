...
from detection.visualize import save_detection_results, draw_detections
...
def main():
    ...
    print(f"Loading BDD100K validation data from {args.data_dir}...")
    ...
    dataloader = DataLoader(subset, batch_size=1, shuffle=False, collate_fn=bdd100k_collate)
